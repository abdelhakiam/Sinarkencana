...
este módulo calcula comissão de vendas na fatura, Comissão de vendas baseada na categoria de produto, produto, margem
    ...
    POS Commission Based Invoice
    POS Commission Based Sales
    POS Commission Based Register Payment
    POS Commission Based Invoice Payment
    POS Commission Based Payment
    POS Commission Based Received Payment
    ...
    "auto_install": False,
    "installable": True,
    'live_test_url':'https://youtu.be/mFUibseRFF4',
